...
//         theme === 'dark' ? 'from-gray-800 to-gray-900' : 'from-gray-100 to-gray-200'
//       } text-gray-100`}
//     >
//       <div
//         className={`max-w-4xl w-full mx-auto p-6 rounded-xl z-10 bg-opacity-80 backdrop-blur-lg ${
//           theme === 'dark' ? 'bg-gray-900/80' : 'bg-white/80'
//         } shadow-2xl border border-opacity-30 ${
//           theme === 'dark' ? 'border-indigo-500' : 'border-teal-400'
//         }`}
//       >
//         {/* Header */}
//         <div
//           className={`p-4 border-b ${
//             theme === 'dark' ? 'border-indigo-600' : 'border-teal-300'
...
//             className={`px-4 py-2 rounded-lg font-semibold transition-colors duration-300 bg-gradient-to-r from-orange-400 to-orange-600 text-white shadow-md hover:from-orange-500 hover:to-orange-700 z-20`}
//           >
//             New Chat
//           </button>
//         </div>
...
//         {/* Chat Area */}
//         <div
//           className={`h-96 p-6 overflow-y-auto rounded-lg my-4 shadow-inner border-2 ${
//             theme === 'dark' ? 'border-indigo-500 bg-gray-800/50' : 'border-teal-400 bg-gray-50/50'
//           }`}
//         >
//           {messages.length === 0 && (
...
//               <div
//                 className={`relative max-w-2xl p-4 rounded-xl shadow-lg z-10 ${
//                   theme === 'dark' ? 'bg-gradient-to-r from-indigo-500 to-indigo-700' : 'bg-gradient-to-r from-blue-300 to-blue-500'
//                 } text-gray-100`}
//               >
...
//             theme === 'dark' ? 'border-indigo-600' : 'border-teal-300'
//           } shadow-lg rounded-b-xl z-20 bg-opacity-90 backdrop-blur-sm ${
...
//               className={`flex-1 p-3 rounded-l-lg border-2 resize-none h-12 focus:outline-none transition-all duration-300 ${
//                 theme === 'dark'
//                   ? 'bg-gray-800 text-gray-200 border-indigo-500 focus:ring-2 focus:ring-indigo-400'
//                   : 'bg-white text-gray-900 border-teal-400 focus:ring-2 focus:ring-teal-300'
//               } shadow-sm`}
//               onKeyPress={(e) => {
...
//               type="submit"
//               disabled={loading}
//               className={`p-3 rounded-r-lg transition-colors duration-300 bg-gradient-to-r from-orange-400 to-orange-600 text-white shadow-md ${
//                 loading ? 'opacity-50 cursor-not-allowed' : 'hover:from-orange-500 hover:to-orange-700'
//               } z-20`}
//             >
//               <svg
