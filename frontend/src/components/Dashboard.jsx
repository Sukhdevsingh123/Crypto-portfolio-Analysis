...
// const AccountInfo = ({ account, dailyChange }) => (
...
//         <p className="text-xl font-bold text-gray-900">${account.cash.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
//       </div>
//       <div>
//         <p className="text-sm text-gray-600">Equity</p>
//         <p className="text-xl font-bold text-gray-900">${account.equity.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
//       </div>
//       <div>
//         <p className="text-sm text-gray-600">Buying Power</p>
//         <p className="text-xl font-bold text-gray-900">${account.buyingPower.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
//       </div>
//     </div>
//     <div className="mt-4">
...
// const ProfitLossSummary = ({ portfolio, positions }) => {
//   const profitLoss = {};
...
// const ApplicationStatus = ({ portfolio, latestTrades, positions }) => {
...
//             plugins: {
//               legend: { position: 'top', labels: { boxWidth: 10, font: { size: 12 } } },
//               tooltip: { callbacks: { label: ctx => `${ctx.label}: $${ctx.raw.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` } }
//             },
...
//   const ltcSpread = ltcSpreadMatch ? 0.5 : 0; // Approximate spread if not directly provided
//   const chartData = {
...
// const Web3Verification = ({ insights, portfolio, positions }) => {
//   const btcValue = positions.find(pos => pos.symbol === 'BTCUSD')?.market_value || 0;
...
//       // Update positions with current prices and market values
...
//   const dailyChange = -5624.54; // Provided in account info; ideally, calculate from historical equity if available

//   return (
//     <div className="container mx-auto p-4 bg-gray-50 min-h-screen">
//       <h1 className="text-3xl font-bold text-gray-900 text-center mb-6">Crypto Portfolio Dashboard</h1>
//       <AccountInfo account={data.account} dailyChange={dailyChange} />
//       <ProfitLossSummary portfolio={data.portfolio} positions={data.account.positions} />
...
//         <ApplicationStatus portfolio={data.portfolio} latestTrades={data.marketData.latestTrades} positions={data.account.positions} />
//       </div>
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//         <WeeklyActivity insights={data.insights} />
//         <Web3Verification insights={data.insights} portfolio={data.portfolio} positions={data.account.positions} />
//       </div>
//     </div>
//   );
// }
